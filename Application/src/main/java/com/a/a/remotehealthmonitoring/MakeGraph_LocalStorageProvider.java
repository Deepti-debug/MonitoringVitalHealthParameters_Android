...
public class MakeGraph_LocalStorageProvider extends DocumentsProvider {
...
//        row.add(Root.COLUMN_ICON, R.drawable.ic_provider);
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(MakeGraph_LocalStorageProvider.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e(MakeGraph_LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(MakeGraph_LocalStorageProvider.class.getSimpleName(), "Error closing thumbnail", e);
                }
        }
