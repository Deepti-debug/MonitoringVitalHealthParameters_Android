...
public class MakeGraph_FileChooserActivity extends FragmentActivity implements
        FragmentManager.OnBackStackChangedListener, MakeGraph_FileListFragment.Callbacks {
    ...
    private void addFragment() {
        MakeGraph_FileListFragment fragment = MakeGraph_FileListFragment.newInstance(mPath);
    ...
    public void onFileSelected(File file) {
        if (file != null) {
            ...
            Toast.makeText(MakeGraph_FileChooserActivity.this, R.string.error_selecting_file,
